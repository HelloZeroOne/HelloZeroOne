###########################################################################
## Makefile generated for component 'Preview_point_calculate_by_chord'. 
## 
## Makefile     : Preview_point_calculate_by_chord.mk
## Generated on : Thu May 12 12:48:45 2022
## Final product: ./Preview_point_calculate_by_chord_rtwlib.a
...
PRODUCT_NAME              = Preview_point_calculate_by_chord
MAKEFILE                  = Preview_point_calculate_by_chord.mk
...
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = Preview_point_calculate_by_chord_rtwlib.a
...
PRODUCT = ./Preview_point_calculate_by_chord_rtwlib.a
...
DEFINES_STANDARD = -DMODEL=Preview_point_calculate_by_chord -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/slprj/slrealtime/Preview_point_calculate_by_chord/slrealtime_datatype_ground.c $(START_DIR)/slprj/slrealtime/Preview_point_calculate_by_chord/Preview_point_calculate_by_chord.cpp
...
OBJS = slrealtime_datatype_ground.o Preview_point_calculate_by_chord.o
...
%.o : $(START_DIR)/slprj/slrealtime/Preview_point_calculate_by_chord/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/slprj/slrealtime/Preview_point_calculate_by_chord/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_datatype_ground.o : $(START_DIR)/slprj/slrealtime/Preview_point_calculate_by_chord/slrealtime_datatype_ground.c
	$(CC) $(CFLAGS) -o $@ $<


Preview_point_calculate_by_chord.o : $(START_DIR)/slprj/slrealtime/Preview_point_calculate_by_chord/Preview_point_calculate_by_chord.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
