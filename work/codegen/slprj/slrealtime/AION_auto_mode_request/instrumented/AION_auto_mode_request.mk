...
## Generated on : Fri May 27 16:03:59 2022
...
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = AION_auto_mode_request_rtwlib.a
...
PRODUCT = ./AION_auto_mode_request_rtwlib.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/slprj/slrealtime/AION_auto_mode_request -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(START_DIR)/slprj/slrealtime/_sharedutils -I$(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/dist/include -I$(MATLAB_ROOT)/toolbox/slrealtime/target/kernel/dist/include
...
DEFINES_STANDARD = -DMODEL=AION_auto_mode_request -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/slprj/slrealtime/AION_auto_mode_request/slrealtime_datatype_ground.c $(START_DIR)/slprj/slrealtime/AION_auto_mode_request/AION_auto_mode_request.cpp
...
OBJS = slrealtime_datatype_ground.o AION_auto_mode_request.o
...
%.o : $(START_DIR)/slprj/slrealtime/AION_auto_mode_request/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/slprj/slrealtime/AION_auto_mode_request/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_datatype_ground.o : $(START_DIR)/slprj/slrealtime/AION_auto_mode_request/slrealtime_datatype_ground.c
	$(CC) $(CFLAGS) -o $@ $<


AION_auto_mode_request.o : $(START_DIR)/slprj/slrealtime/AION_auto_mode_request/AION_auto_mode_request.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
