 ...
 * For more details, see corresponding source file AION_auto_control_realization.c
 *
 */
...
/* Block states (default storage) for model 'AION_auto_control_realization' */
struct DW_AION_auto_control_realization_f_T {
...
struct MdlrefDW_AION_auto_control_realization_T {
  DW_AION_auto_control_realization_f_T rtdw;
  RT_MODEL_AION_auto_control_realization_T rtm;
};

/* Model reference registration function */
extern void AION_auto_control_realization_initialize(const char_T
  **rt_errorStatus, RT_MODEL_AION_auto_control_realization_T *const
  AION_auto_control_realization_M, DW_AION_auto_control_realization_f_T *localDW);
extern void AION_auto_control_realization_Init
  (DW_AION_auto_control_realization_f_T *localDW);
extern void AION_auto_control_realization_Reset
  (DW_AION_auto_control_realization_f_T *localDW);
extern void AION_auto_control_realization(const Control_request
