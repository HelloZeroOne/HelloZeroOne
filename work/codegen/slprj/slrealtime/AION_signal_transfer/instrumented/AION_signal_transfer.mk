...
## Generated on : Fri May 27 15:32:33 2022
...
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = AION_signal_transfer_rtwlib.a
...
PRODUCT = ./AION_signal_transfer_rtwlib.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/slprj/slrealtime/AION_signal_transfer -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(START_DIR)/slprj/slrealtime/_sharedutils -I$(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/dist/include -I$(MATLAB_ROOT)/toolbox/slrealtime/target/kernel/dist/include
...
SRCS = $(START_DIR)/slprj/slrealtime/AION_signal_transfer/slrealtime_datatype_ground.c $(START_DIR)/slprj/slrealtime/AION_signal_transfer/AION_signal_transfer.cpp
...
OBJS = slrealtime_datatype_ground.o AION_signal_transfer.o
...
%.o : $(START_DIR)/slprj/slrealtime/AION_signal_transfer/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/slprj/slrealtime/AION_signal_transfer/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_datatype_ground.o : $(START_DIR)/slprj/slrealtime/AION_signal_transfer/slrealtime_datatype_ground.c
	$(CC) $(CFLAGS) -o $@ $<


AION_signal_transfer.o : $(START_DIR)/slprj/slrealtime/AION_signal_transfer/AION_signal_transfer.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
