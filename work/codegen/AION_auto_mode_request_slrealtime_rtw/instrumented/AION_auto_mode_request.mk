...
PRODUCT = $(START_DIR)/AION_auto_mode_request_slrealtime_rtw/AION_auto_mode_request
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/AION_auto_mode_request_slrealtime_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/dist/include -I$(MATLAB_ROOT)/toolbox/slrealtime/target/kernel/dist/include
...
%.o : $(START_DIR)/AION_auto_mode_request_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/AION_auto_mode_request_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_datatype_ground.o : $(START_DIR)/AION_auto_mode_request_slrealtime_rtw/slrealtime_datatype_ground.c
	$(CC) $(CFLAGS) -o $@ $<
...
rtGetInf.o : $(START_DIR)/AION_auto_mode_request_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/AION_auto_mode_request_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/AION_auto_mode_request_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/AION_auto_mode_request_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
