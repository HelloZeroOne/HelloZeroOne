...
struct B_AION_auto_mode_request_T {
  ...
  real_T ADCU_Msg1;                    /* '<Root>/ADCU_life_signal' */
  real_T ADCU_Checksum2;               /* '<Root>/ADCU_life_signal' */
  real_T ADCU_Msg2;                    /* '<Root>/ADCU_life_signal' */
  real_T ADCU_Checksum3;               /* '<Root>/ADCU_life_signal' */
  real_T ADCU_Msg3;                    /* '<Root>/ADCU_life_signal' */
  ...
  uint32_T DataTypeConversion4;        /* '<Root>/Data Type Conversion4' */
  uint32_T DataTypeConversion5;        /* '<Root>/Data Type Conversion5' */
  uint32_T DataTypeConversion6;        /* '<Root>/Data Type Conversion6' */
  int32_T set_AutoTrqWhlReq;
           /* '<Root>/BusConversion_InsertedFor_OutBus_Outport_1_at_inport_0' */
...
struct ExtU_AION_auto_mode_request_T {
  Control_request control_available_set_lateral_control_info_set_LatCtrlReq;/* '<Root>/B_-1_-1' */
  real_T control_available_set_lateral_control_info_set_SteerWhlTorqReq;/* '<Root>/B_-1_-1' */
  real_T control_available_set_lateral_control_info_set_SteerAngReq;/* '<Root>/B_-1_-1' */
  real_T control_available_set_lateral_control_info_set_SteerAngSpdLimt;/* '<Root>/B_-1_-1' */
  Control_request control_available_set_longitudinal_control_info_set_LngCtrlReq;/* '<Root>/B_-1_-1' */
  int32_T control_available_set_longitudinal_control_info_set_AutoTrqWhlReq;/* '<Root>/B_-1_-1' */
  real_T control_available_set_longitudinal_control_info_set_BrakeReq;/* '<Root>/B_-1_-1' */
  AION_gear control_available_set_longitudinal_control_info_set_GearLvlReq;/* '<Root>/B_-1_-1' */
  Validation_status
    control_available_set_longitudinal_control_info_set_GearLvlReqVD;/* '<Root>/B_-1_-1' */
  uint32_T control_available_set_ADCU_info_set_Checksum1;/* '<Root>/B_-1_-1' */
  uint32_T control_available_set_ADCU_info_set_MsgCounter1;/* '<Root>/B_-1_-1' */
  uint32_T control_available_set_ADCU_info_set_Checksum2;/* '<Root>/B_-1_-1' */
  uint32_T control_available_set_ADCU_info_set_MsgCounter2;/* '<Root>/B_-1_-1' */
  uint32_T control_available_set_ADCU_info_set_Checksum3;/* '<Root>/B_-1_-1' */
  uint32_T control_available_set_ADCU_info_set_MsgCounter3;/* '<Root>/B_-1_-1' */
  Beam_request control_available_set_ADCU_info_set_BeamReq;/* '<Root>/B_-1_-1' */
  Enable_request control_available_set_ADCU_info_set_BodyCtrlReq;/* '<Root>/B_-1_-1' */
  Active_request control_available_set_ADCU_info_set_HornRingReq;/* '<Root>/B_-1_-1' */
  Light_request control_available_set_ADCU_info_set_TurnLightReq;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_ABSActiveSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_ABSFaultSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_VDCActiveSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_VDCFaultSt;/* '<Root>/B_-1_-1' */
  real_T control_available_get_BCS_info_get_VehSpd;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_VehSpdVD;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_BCS_info_get_FLWheelSpdEdgesSum;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_FLWheelSpdEdgesSumVD;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_BCS_info_get_FRWheelSpdEdgesSum;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_FRWheelSpdEdgesSumVD;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_BCS_info_get_RLWheelSpdEdgesSum;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_RLWheelSpdEdgesSumVD;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_BCS_info_get_RRWheelSpdEdgesSum;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_RRWheelSpdEdgesSumVD;/* '<Root>/B_-1_-1' */
  real_T control_available_get_BCS_info_get_YawRate;/* '<Root>/B_-1_-1' */
  real_T control_available_get_BCS_info_get_YawRateOffset;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_YawRateSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_HDCCtrlSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_HDCErrSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_AEBActive;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_AEBAvailable;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_CDDActive;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_CDDAvailable;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_CDDFail;/* '<Root>/B_-1_-1' */
  real_T control_available_get_BCS_info_get_MasterCylinderPr;/* '<Root>/B_-1_-1' */
  real_T control_available_get_BCS_info_get_MasterCylinderPrOffset;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_MasterCylinderPrOffsetVD;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_MasterCylinderPrVD;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_NoBrakeForce;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_VehicleStandStillSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_FLWheelRotatedDirection;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_FLWheelRotatedDirectionVD;/* '<Root>/B_-1_-1' */
  real_T control_available_get_BCS_info_get_FLWheelSpd;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_FLWheelSpdVD;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_FRWheelRotatedDirection;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_FRWheelRotatedDirectionVD;/* '<Root>/B_-1_-1' */
  real_T control_available_get_BCS_info_get_FRWheelSpd;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_FRWheelSpdVD;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_RLWheelRotatedDirection;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_RLWheelRotatedDirectionVD;/* '<Root>/B_-1_-1' */
  real_T control_available_get_BCS_info_get_RLWheelSpd;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_RLWheelSpdVD;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_RRWheelRotatedDirection;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_RRWheelRotatedDirectionVD;/* '<Root>/B_-1_-1' */
  real_T control_available_get_BCS_info_get_RRWheelSpd;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_RRWheelSpdVD;/* '<Root>/B_-1_-1' */
  real_T control_available_get_BCS_info_get_ActVehLaltrlAccel;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_ActVehLaltrlAccelVD;/* '<Root>/B_-1_-1' */
  real_T control_available_get_BCS_info_get_ActVehLongAccel;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCS_info_get_ActVehLongAccelVD;/* '<Root>/B_-1_-1' */
  real_T control_available_get_BCS_info_get_VehLaltrlAccelOffset;/* '<Root>/B_-1_-1' */
  real_T control_available_get_BCS_info_get_VehLongAccelOffset;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_VCU_info_get_GearLeverIntv;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_VCU_info_get_VehDrvMod;/* '<Root>/B_-1_-1' */
  Ready_status control_available_get_VCU_info_get_VehRdySt;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_VCU_info_get_VehRng;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_VCU_info_get_ActRecpTorq;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_VCU_info_get_ActRecpTorqSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_VCU_info_get_CrntGearLvl;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_VCU_info_get_CrntGearLvlVD;/* '<Root>/B_-1_-1' */
  real_T control_available_get_VCU_info_get_ACCMaxRecpDecel;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_VCU_info_get_ACCMaxRecpDecelVD;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_VCU_info_get_ActVehWheelTorq;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_VCU_info_get_LateralAssistBtnInfo;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_VCU_info_get_LateralAssistBtnInfoVD;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_VCU_info_get_ACCButtInfo;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_VCU_info_get_AccElecECFail;/* '<Root>/B_-1_-1' */
  real_T control_available_get_VCU_info_get_GasPedalActPst;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_VCU_info_get_GasPedalActPstVD;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_VCU_info_get_VehWheelTorqMax;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_VCU_info_get_BrkPedalSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_VCU_info_get_BrkPedalStVD;/* '<Root>/B_-1_-1' */
  real_T control_available_get_VCU_info_get_GasPedalVirtualPst;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_VCU_info_get_GasPedalVirtualPstVD;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_Checksum1;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_MsgCounter1;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_Checksum10;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_MsgCounter10;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_Checksum11;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_MsgCounter11;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_Checksum12;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_MsgCounter12;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_Checksum13;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_MsgCounter13;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_SCU_info_get_EStopSwSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_SCU_info_get_EStopSwStVD;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_LatAutoCheckReport;/* '<Root>/B_-1_-1' */
  Control_status control_available_get_SCU_info_get_LatCtrlMode;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_LatQuitReport;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_LngAutoCheckIReport;/* '<Root>/B_-1_-1' */
  Control_status control_available_get_SCU_info_get_LngCtrlMode;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_LngQuitReport;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_SCU_info_get_StrngWhlIntv;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_Checksum16;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_MsgCounter16;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_Checksum17;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_MsgCounter17;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_Checksum18;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_MsgCounter18;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_Checksum2;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_MsgCounter2;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_Checksum3;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_MsgCounter3;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_Checksum4;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_MsgCounter4;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_Checksum5;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_MsgCounter5;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_Checksum6;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_MsgCounter6;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_Checksum7;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_MsgCounter7;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_Checksum8;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_MsgCounter8;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_Checksum9;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_SCU_info_get_MsgCounter9;/* '<Root>/B_-1_-1' */
  Error_status control_available_get_EPB_info_get_FailSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_EPB_info_get_SwitchSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_EPB_info_get_SwitchStVD;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_EPB_info_get_SysSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_SRS_info_get_DriverSeatBeltSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_SRS_info_get_PsngrSeatBeltSt;/* '<Root>/B_-1_-1' */
  real_T control_available_get_EPS_info_get_SteeringAngle;/* '<Root>/B_-1_-1' */
  uint32_T control_available_get_EPS_info_get_SteeringAngleSpd;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_EPS_info_get_SteeringAngleSpdVD;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_EPS_info_get_SteeringAngleVD;/* '<Root>/B_-1_-1' */
  real_T control_available_get_EPS_info_get_StrngWhlTorq;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_EPS_info_get_StrngWhlTorqVD;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_EPS_info_get_ThermalSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_EPS_info_get_WarnLamp;/* '<Root>/B_-1_-1' */
  Available_status control_available_get_BCM_info_get_CtrlAvailable;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCM_info_get_DriverDoorAjarSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCM_info_get_FrontFogLampSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCM_info_get_FrontWiperSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCM_info_get_HazardLampSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCM_info_get_HighBeamSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCM_info_get_HornSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCM_info_get_KeySt;/* '<Root>/B_-1_-1' */
  Fault_status control_available_get_BCM_info_get_LeftTurnLampFaultSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCM_info_get_LeftTurnLampSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCM_info_get_LowBeamSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCM_info_get_PsngrDoorAjarSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCM_info_get_RLDoorAjarSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCM_info_get_RRDoorAjarSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCM_info_get_RearFogLampSt;/* '<Root>/B_-1_-1' */
  Fault_status control_available_get_BCM_info_get_RightTurnLampFaultSt;/* '<Root>/B_-1_-1' */
  uint8_T control_available_get_BCM_info_get_RightTurnLampSt;/* '<Root>/B_-1_-1' */
};
...
struct ExtY_AION_auto_mode_request_T {
  ...
  int32_T OutBus_set_longitudinal_control_info_set_AutoTrqWhlReq;
 ...
 * '<S3>'   : 'AION_auto_mode_request/Lateral_control_status_judge1'
 * '<S4>'   : 'AION_auto_mode_request/Longitudinal_control_status_judge'
 * '<S5>'   : 'AION_auto_mode_request/MATLAB Function'
 * '<S6>'   : 'AION_auto_mode_request/MATLAB Function1'
 * '<S7>'   : 'AION_auto_mode_request/body_control_request'
 */
