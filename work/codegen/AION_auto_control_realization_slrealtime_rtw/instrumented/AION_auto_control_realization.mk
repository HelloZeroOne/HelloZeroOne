...
## Generated on : Sun May 22 21:13:27 2022
## Final product: $(START_DIR)/AION_auto_control_realization_slrealtime_rtw/AION_auto_control_realization
...
PRODUCT = $(START_DIR)/AION_auto_control_realization_slrealtime_rtw/AION_auto_control_realization
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/AION_auto_control_realization_slrealtime_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/dist/include -I$(MATLAB_ROOT)/toolbox/slrealtime/target/kernel/dist/include
...
SRCS = $(START_DIR)/AION_auto_control_realization_slrealtime_rtw/slrealtime_datatype_ground.c $(START_DIR)/AION_auto_control_realization_slrealtime_rtw/AION_auto_control_realization.cpp $(START_DIR)/AION_auto_control_realization_slrealtime_rtw/main.cpp host_timer_x86.c slrealtime_code_profiling_utility_functions.cpp
...
OBJS = slrealtime_datatype_ground.o AION_auto_control_realization.o main.o host_timer_x86.o slrealtime_code_profiling_utility_functions.o
...
%.o : $(START_DIR)/AION_auto_control_realization_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/AION_auto_control_realization_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_datatype_ground.o : $(START_DIR)/AION_auto_control_realization_slrealtime_rtw/slrealtime_datatype_ground.c
	$(CC) $(CFLAGS) -o $@ $<


AION_auto_control_realization.o : $(START_DIR)/AION_auto_control_realization_slrealtime_rtw/AION_auto_control_realization.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/AION_auto_control_realization_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
